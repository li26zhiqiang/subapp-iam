    ...
    <el-card shadow="never">
        <el-form :model="menu" :rules="rules" ref="menuFrom" label-width="150px">
            <el-form-item label="菜单名称：" prop="title">
                <el-input class="input-width" v-model="menu.title"></el-input>
            </el-form-item>
            ...
            <el-form-item label="前端名称：" prop="name">
                <el-input class="input-width" v-model="menu.name"></el-input>
            </el-form-item>
            <el-form-item label="前端图标：" prop="icon">
                <el-input class="input-width" v-model="menu.icon" style="width: 80%"></el-input>
            ...
            <el-form-item label="排序：">
                <el-input class="input-width" v-model="menu.sort"></el-input>
            </el-form-item>
            <el-form-item>
